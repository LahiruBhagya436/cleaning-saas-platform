    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="container-tight py-16 text-center max-w-md mx-auto">
        ...
        <p className="text-neutral-500 mb-8 leading-relaxed">
          ...
          One of our cleaners will take care of your home on{' '}
          <span className="font-medium text-neutral-800 capitalize">
            {format(scheduledDate, "d MMMM 'at' HH:mm", { locale: enGB })}
          </span>.
        </p>
        ...
        <div className="bg-white border border-neutral-200 rounded-xl p-5 mb-6 text-left space-y-3">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="text-neutral-800 capitalize">
              {format(scheduledDate, "EEE d MMM 'at' HH:mm", { locale: enGB })}
            </span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-neutral-500">Status</span>
            <span className="text-teal-600 font-medium">Confirmed</span>
          </div>
        ...
        <div className="bg-brand-50 border border-brand-100 rounded-xl p-5 mb-8 text-left">
          <h3 className="text-sm font-medium text-brand-900 mb-3">What happens next?</h3>
          <div className="space-y-2.5">
            {[
              'You will receive an email confirmation within a few minutes',
              'The day before, you will get a reminder about your booking',
              'The cleaner arrives at the agreed time',
              'After the cleaning, you rate the service in the app',
            ].map((step, i) => (
