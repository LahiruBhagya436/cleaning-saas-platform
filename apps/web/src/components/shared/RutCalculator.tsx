  ...
  return (
    <div className="bg-white rounded-2xl border border-neutral-200 shadow-modal p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="font-sans font-medium text-neutral-900">Calculate your price</h3>
      ...
      <div className="mb-6">
        <div className="flex justify-between text-sm mb-2">
          <label className="text-neutral-600 font-medium">Number of hours</label>
          <span className="font-medium text-neutral-900">{hours} hrs</span>
        </div>
        <input
          type="range"
          min={1}
      ...
      <div className="space-y-2.5 mb-6">
        <div className="flex justify-between text-sm">
          <span className="text-neutral-500">Labour cost ({HOURLY_RATE} kr/hr × {hours} hrs)</span>
        ...
        <div className="border-t border-dashed border-teal-200 pt-2.5">
          <div className="flex justify-between text-sm">
            <span className="text-teal-600 font-medium">RUT deduction (−50%)</span>
      ...
      <div className="bg-brand-50 rounded-xl p-4 mb-5 flex items-center justify-between">
        <div>
          <p className="text-xs text-neutral-500 mb-0.5">You pay</p>
      ...
      <p className="text-xs text-center text-neutral-400 mt-3">
        No commitment · Cancel for free 24h in advance
      </p>
    </div>
  )
}
